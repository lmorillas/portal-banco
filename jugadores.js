...
const jugadoresArsenal = jugadores.filter(jugador => jugador.team === "Arsenal")

const modArsenalPLayers = jugadoresArsenal.map(jugador => {
    return {
        fullName: `${jugador.first_name} ${jugador.last_name}`,
